...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'profiles', ['SiteUser'])

        # Adding M2M table for field groups on 'SiteUser'
        m2m_table_name = db.shorten_name(u'profiles_siteuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('siteuser', models.ForeignKey(orm[u'profiles.siteuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['siteuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'SiteUser'
        m2m_table_name = db.shorten_name(u'profiles_siteuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('siteuser', models.ForeignKey(orm[u'profiles.siteuser'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'profiles_siteuser')

        # Removing M2M table for field groups on 'SiteUser'
        db.delete_table(db.shorten_name(u'profiles_siteuser_groups'))

        # Removing M2M table for field user_permissions on 'SiteUser'
        db.delete_table(db.shorten_name(u'profiles_siteuser_user_permissions'))
