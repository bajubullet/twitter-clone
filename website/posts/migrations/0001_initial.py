...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_post', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.SiteUser'])),
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.SiteUser']"}),
